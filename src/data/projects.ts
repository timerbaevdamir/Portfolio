...
export const PROJECTS: Project[] = [
  ...
  },
  {
    slug: "ui-agent",
    title: "UI-агент",
    tagline: "Опишите экран словами — агент собирает его на дизайн-системе и показывает рядом",
    year: 2026,
    ...
    viewports: ["desktop"],
    summary:
      "Интерфейс агента, который собирает экраны по текстовому описанию — " +
      "не абстрактную картинку, а вёрстку на компонентах конкретной " +
      "дизайн-системы. Разговор слева, результат рядом.",
    notes: [
      {
        title: "Пустое состояние задаёт вопрос",
        body:
          "«Что собрать сегодня?» — и сразу поле ввода. Не список " +
          "возможностей, не тур по продукту: первое, что видит человек, — " +
          "место, куда писать, и одна строка, объясняющая, что произойдёт " +
          "дальше.",
      },
      {
        title: "Композер — один блок, а не панель инструментов",
        body:
          "Поле, вложение, голос, выбор модели и отправка живут внутри " +
          "одной рамки. Выбор модели стоит там же, где текст, потому что это " +
          "часть того же решения — чем собирать, — а не настройка приложения.",
      },
      {
